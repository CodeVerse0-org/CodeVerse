...
const AuditLogs = () => {
  // Open by default on desktop viewports
  ...
  // Automatically adjust sidebar based on initial screen width
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020405] flex flex-col font-sans relative">
      {/* Top Fixed Admin Navbar */}
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {/* Sidebar Component Wrapper with Responsive Desktop/Mobile Positioning */}
        <aside
          className={`fixed lg:static z-30 h-[calc(100vh-64px)] transition-all duration-300 ease-in-out ${
        ...
        <main className="flex-1 bg-[#020405] text-gray-300 p-4 md:p-8 overflow-y-auto w-full transition-all">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 border-b border-white/5 pb-8">
            <div>
              ...
              <p className="text-gray-500 text-xs mt-1 leading-relaxed">
                Real-time tracking of assigned repository syncs, developer
                activities, and graph runs.
              </p>
            </div>
                    ...
                    {filteredLogs.map((log) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`px-2.5 py-1 text-[10px] font-bold uppercase border rounded-md ${getActionStyle(
                              log.action
                            )}`}
                          >
                            {log.action || "UNKNOWN"}

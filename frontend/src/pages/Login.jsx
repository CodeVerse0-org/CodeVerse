  ...
  return (
    <div className="h-screen w-full bg-[#020405] text-gray-200 font-sans overflow-hidden flex selection:bg-cyan-500/30 relative">
      ...
      <div className="flex w-full h-full relative z-10">
        ...
        {/* Right Side: Login Form (Only the internal text changes, not the whole container) */}
        <div className="flex-1 flex items-center justify-center p-8 z-10 backdrop-blur-[2px]">
          <div className="w-full max-w-md space-y-8 bg-black/40 p-10 rounded-3xl border border-white/5 shadow-2xl backdrop-blur-xl transition-all duration-500">
            ...
            <div className="space-y-1">
              ...
              <p className="text-gray-500 text-xs font-bold uppercase tracking-tighter transition-opacity duration-300">
                {role === "admin"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.03] border border-white/10 rounded-xl px-11 py-3 text-sm outline-none focus:border-cyan-500/50 transition-all text-white"
                  />
                </div>
              </div>

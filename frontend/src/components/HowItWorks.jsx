...
const Step = ({ number, title, description, delay }) => (
  <motion.div 
    ...
    className="relative group flex flex-col items-center text-center max-w-xs p-8 rounded-[2.5rem] border border-white/5 bg-white/[0.02] backdrop-blur-sm hover:border-cyan-500/30 transition-all duration-500 cursor-pointer"
  >
